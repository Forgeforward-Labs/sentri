...
export class ContractService {
  ...
  async getProduct(id: number): Promise<ChainProduct> {
    ...
    return {
      ...
      triggerType:    raw[2] as 0 | 1,
      triggerParams:  raw[3] as `0x${string}`,
      premiumRateBps: raw[4] as bigint,
      duration:       raw[5] as bigint,
      maxPerPosition: raw[6] as bigint,
      poolLimit:      raw[7] as bigint,
      totalCommitted: raw[8] as bigint,
      referenceTVL:   raw[9] as bigint,
      active:         raw[10] as boolean,
    };
  }
